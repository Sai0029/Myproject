<?php
    ...
    $password = "1234"; // Default MySQL password for XAMPP is empty
...
<div class="sidebar">
    ...
    <a href="#"><i class="fas fa-comments"></i> Feedbacks</a>
</div>
...
<div class="modal fade" id="modalForAddExam" tabindex="-1" role="dialog" aria-labelledby="addExamModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Exam Form Fields -->
                    <form id="addExamForm" action="process-form.php" method="POST">
                        <div class="form-group">
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "nsai0029@gmail.com",
        Password: "DB06E2CBC674D281EF013788A86D6364352E",
